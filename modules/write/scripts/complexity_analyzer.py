...
用法：
  python3 modules/write/scripts/complexity_analyzer.py paper.md
  python3 modules/write/scripts/complexity_analyzer.py paper.md --json
  python3 modules/write/scripts/complexity_analyzer.py paper.md --out complexity_report.md
"""
