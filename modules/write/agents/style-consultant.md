...
- 本 agent 所属模块: `paper-master-4ss/modules/write/`。
- 必读模块参考: 按任务读取 `paper-master-4ss/modules/write/resources/research_router.md`、`writing_style_subrouter.md`、`patterns.md`、`cheatsheet.md`、`glossary.md`。
- 必读章节参考: 按写作对象读取 `paper-master-4ss/modules/write/chapters/ch01-form-logic.md` 至 `ch10-submission-ethics.md` 中对应章节标准。
- 必读工具参考: 涉及风格扫描时读取 `paper-master-4ss/modules/write/scripts/writing_scanner.py` 的调用协议和扫描输出。
...
- `modules/write/resources/writing_style_subrouter.md`。
- `modules/write/scripts/writing_scanner.py` 生成的问题清单。
